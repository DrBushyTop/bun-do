...
abstract class InboxDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        val MIGRATION_17_18 = object : Migration(17, 18) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL("ALTER TABLE shared_workspaces ADD COLUMN personal INTEGER NOT NULL DEFAULT 0")
            }
        }

        val MIGRATION_18_19 = object : Migration(18, 19) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL("ALTER TABLE shared_workspaces ADD COLUMN adventureFetchedAt INTEGER NOT NULL DEFAULT 0")
            }
        }
